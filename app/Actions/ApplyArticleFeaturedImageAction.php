...
final readonly class ApplyArticleFeaturedImageAction
{
     ...
     * @return array{photo_id: int|null, meta: array<string, mixed>}|RedirectResponse
     */
    public function handle(Request $request, array $data, ?Article $article = null): array|RedirectResponse
    {
