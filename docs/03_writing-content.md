...
> **For Developers:** BlogWriter uses Editor.js for the article editor, providing a modern block-based editing
...
> **For Developers:** The `.md` endpoint sets `Content-Type: text/markdown` and is useful for LLMs and automated tools
...
> **Technical Note:** BlogWriter automatically extracts EXIF metadata from your photos when available (camera model,
...
> **For Developers:** Settings can also be managed via the CLI or by editing configuration files directly.

#### [Up Next: *Themes*](04_themes.md)
