...
> **Important:** Make sure this matches your actual domain. It's critical for feeds and IndieWeb features to work correctly.
...
> **Recommendation:** Use Resend or Postmark. They're easier to set up than SMTP and have better deliverability. Save SMTP for when you already have email infrastructure set up.
...
> **DNS is not optional.** Without SPF and DKIM records, your emails will land in spam or be rejected entirely. Every legitimate email service requires this setup.
...
> **Warning:** This overwrites your current settings. Make sure you have a backup first.
...
#### [Up Next: *Feeds & IndieWeb*](07_feeds-and-indieweb.md)