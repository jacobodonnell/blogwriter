<x-settings-layout active="appearance">
    <div x-data="appearanceSettings({
            currentLight: @js($currentLight),
            currentDark: @js($currentDark),
            currentFont: @js($currentFont),
            fonts: @js($fonts),
        })"
                    ...
                    <div class="card-body">
                        ...
                        <div class="relative mt-3">
                            <button type="button"
                                    ...
                                    class="btn btn-outline w-full justify-between font-admin">
                                <span x-text="fonts[font]" class="font-admin" data-test="font-label"></span>
