<x-layouts.customizer :title="($isNew ?? false) ? 'New Article' : 'Edit: ' . $article->title" :article="$article">
    ...
    <div @photo-attached="handlePhotoAttached($event.detail)"
         x-data="articleCustomizer({
            ...
            featuredImageUrl: @js(old('featured_image', $article->external_featured_img_url ?? '')),
            showUrlField: @js(!empty(old('featured_image', $article->external_featured_img_url ?? ''))),
            ...
            savedFeaturedImageUrl: @js($liveExternalFeaturedImgUrl ?? ''),
